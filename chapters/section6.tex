...
\begin{itemize} 
	...
	\item \getprefix{ide}: NetBeans, \getprefix{mysqlw}, \getprefix{git}, \getprefix{scrum}
...
\begin{itemize} 
	...
	\item \getprefix{type}: \getprefix{ass}
	\item \getprefix{college}: \getprefix{ntnu}
	\item \getprefix{ide}: \getprefix{unity}, \getprefix{nppp}, \getprefix{mysqlw}, d3.js\footnote{\url{https://d3js.org/}}, \getprefix{git}, 
