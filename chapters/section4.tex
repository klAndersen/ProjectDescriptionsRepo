...
\vspace{0.5em}\newline
The Java Web server was created using \getprefix{html}, \getprefix{jserv} and JSP, running on Apache TomCat v7.0. 
...
\begin{itemize} 
	...
	\item \getprefix{progLang}: \getprefix{java}, \getprefix{android}, \getprefix{xml}, \getprefix{php}, \getprefix{git}, JSON
